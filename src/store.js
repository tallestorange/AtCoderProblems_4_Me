  ...
  mutations: {
    ...
    setProblemsDataFromAPI(state, payload) {
      ...
      for (let key in problemsData) {
        ...
        problemsDict[problem.id].contest_title =
          contestsData[problem.contest_id].title;
        problemsDict[problem.id].your_ac_count = 0;
        problemsDict[problem.id].your_wa_count = 0;
        problemsDict[problem.id].url =
      ...
      state.scoresForView = scoresDict;
    ...
    updateSubmissionsData(state, payload) {
      ...
      let submissions = JSON.parse(
        JSON.stringify(state.submissionsDictionary[userName])
      );
    ...
    updateProblemsData(state, payload) {
      ...
      let problems = JSON.parse(
        JSON.stringify(state.problemsDictionary[userName])
      );
